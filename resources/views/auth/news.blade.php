                        ...
                        <section class="flex flex-wrap">
                            ...
                            <main class="w-10/12 p-6">
                                <h3 class="font-serif font-bold text-3xl flex justify-between items-center">
                                    News
                                    <a class="font-sans uppercase text-xs bg-blue-800 font-bold text-white py-1 px-3" href="/home/add-news">
                                ...
                                <table class="w-full">
                                    ...
                                    @foreach($news as $new)
                                        <tr class="border">
                                            <td class="border-r px-2 bg-gray-100">{{ $new->id }}.</td>
                                            <td class="border-r px-2 w-1/2">
                                                <img class="inline" src="/img/{{ $new->image }}" alt="img" width="30%"> &nbsp;
                                                <a class="text-xs" href="/home/news/{{ $new->location }}/edit">{{ $new->headline }}</a>
                                            </td>
                                            ...
                                            <td class="px-2 bg-gray-100 border-r px-2 text-center">
                                                <a class="text-xs" href="/home/news/{{ $new->location }}/edit"><i class="far fa-edit"></i></a>
                                            </td>
                                            <td class="px-2 text-center">
                                                <form action="/home/news/{{ $new->location }}/destroy" method="POST">
                                                    @csrf
                                                    @method('DELETE')
